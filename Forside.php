...
<head>
    ...
    <title>Clientlee - Brugervenlig administrationsprogram</title>
...
<div class="container">
    <div class="row">
        ...
        <div class="p-4 col-sm-12 col-md-6 col-lg-6 mt-lg-5 offset-lg-1">
            ...
            <p class="fortekst1">Få et fuldt overblik over din kundekreds.
            </p>
            <p class="fortekst2"><i class="check fa-solid fa-circle-check me-2"></i>Dashbord </p>
